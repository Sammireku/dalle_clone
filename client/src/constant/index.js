export const surpriseMePrompts = [
  'modern startup logo, symmetrical, minimalistic robot icon, centered, gradient, dark background',
  'abstract geometric shapes',
  'hair saloon logo designs',
  'icon design for a bakery',
  'modern startup logo, symmetrical, minimalistic chessboard icon, centered, monogram, dark background',
  'modern logo, minimalistic, beverage, icon, centered, monogram, white background',
  'healthcare logo, minimalistic, beverage, icon, centered, monogram, white background',
  'abstract, shape, two colors, minimalistic, logo, circular',
  'abstract, shape, two colors, minimalistic, logo, geometric, three lines',
